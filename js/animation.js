...
(function () {
  var pageHeaderBlockHeight =
    document.querySelector(".page-header").clientHeight;
  var pageMainBlockHeight = document.querySelector(
    ".page-main__linear-wrapper"
  ).clientHeight;
  var experienceBlockHeight =
    document.querySelector(".experience").clientHeight;
  var goalsBlockHeight =
    document.querySelector(".my-goals__wrapper").clientHeight;
  var technologiesBlockHeight =
    document.querySelector(".technologies").clientHeight;
  ...
  function goalsAnimation() {
    ...
    var coords =
      pageHeaderBlockHeight +
      pageMainBlockHeight +
      experienceBlockHeight -
      scrollFix;
